'''
this code is borrowed from https://github.com/assafshocher/ResizeRight
'''
...
from src.data import interp_method

def resize(input, scale_factors=None, out_shape=None,
           interp_method=interp_method.cubic, support_sz=None, 
           antialiasing=True):
...
if __name__ == '__main__':
    a = np.randn(3, 256, 256)
    b = torch.randn(3, 256, 256)

    a_rs = resize(a, scale_factors=1/4)
    b_rs = resize(b, scale_factors=1/4)

    print(a.shape, a_rs.shape, b.shape, b_rs.shape)